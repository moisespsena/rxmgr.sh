...
class CommandException extends Exception
{
    ...
    {
        parent::__construct($cmd->stderr(), $cmd->code());
        $this->cmd = $cmd;
    }
}
...
class Cmd
{
     ...
     */
    static public function make($cmd = null, $noescape = false)
    {
        $obj = new self();
        if ($cmd !== NULL) {
            $obj->cmd($cmd, $noescape);
        }
        return $obj;
    }

    static public function mk($cmd = null, $noescape = false)
    {
        return self::make($cmd, $noescape);
    }
     ...
     * @return Command - Fluent interface
     */
    public function cmd($cmd, $noescape = false)
    {
     ...
     * @return Command - Fluent interface
     */
    public function opt($left, $right = null, $sep = null)
    {
        if ($right !== NULL) {
